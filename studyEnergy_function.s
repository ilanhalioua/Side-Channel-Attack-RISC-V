...
loop: bgt t0 t1 end_loop
  ...
  la a0 password #reset the a0 to have the address of password again for next call
...
lw ra 8(sp)
addi sp sp 16 #reset the stack pointer to its original address (bottom of the stack)
