...
jr ra
exception_handled:
la a0 password #reset address to be the first character of password string
addi sp sp -12 #make 2 word os space in the stack for later(for ra and iteration counter t0)
